...
export const Hero = () => {
  ...
  return (
    <div className="hero min-h-[700px] relative" style={styles}>
      ...
      <div className="absolute bottom-0 right-0 text-[6pt] bg-white bg-opacity-50 pl-2 pr-2 z-50">
        <Link
          to={
            'https://unsplash.com/@photosbychalo?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash'
          }
          target="_blank"
        >
