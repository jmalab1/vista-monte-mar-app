  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="mt-4 w-full rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-sm font-semibold text-slate-700 transition hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-300 focus:ring-offset-2"
      >
        Open Guest Website
      </button>
      ...
      <button
        ...
        className="mt-3 w-full rounded-lg border border-blue-700 bg-blue-700 px-3 py-2.5 text-sm font-semibold text-white transition hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-300 focus:ring-offset-2"
